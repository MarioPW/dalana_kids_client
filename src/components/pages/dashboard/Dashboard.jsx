...
export const Dashboard = () => {
  ...
  return (
    <div className="block w-full sm:text-left sm:w-5/6 mt-12">
      <div>
        <button 
        type="button"
      ...
      -->*/}
      <div className="right-0 z-10 mt-2 w-full origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button">
